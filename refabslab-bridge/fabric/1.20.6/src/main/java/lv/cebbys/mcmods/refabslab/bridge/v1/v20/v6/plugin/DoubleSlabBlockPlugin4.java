...
@RefabslabPluginIdentifier(type = AbstractDoubleSlabBlockPlugin.class, major = 1, minor = 16, patch = 3)
public class DoubleSlabBlockPlugin4 extends AbstractDoubleSlabBlockPlugin<Block> {
    @Override
