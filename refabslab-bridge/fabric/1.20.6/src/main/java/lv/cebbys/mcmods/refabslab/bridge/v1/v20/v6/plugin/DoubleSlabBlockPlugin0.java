...
@RefabslabPluginIdentifier(type = AbstractDoubleSlabBlockPlugin.class, major = 1, minor = 20, patch = 7)
public class DoubleSlabBlockPlugin0 extends AbstractDoubleSlabBlockPlugin<Block> {
    @Override
