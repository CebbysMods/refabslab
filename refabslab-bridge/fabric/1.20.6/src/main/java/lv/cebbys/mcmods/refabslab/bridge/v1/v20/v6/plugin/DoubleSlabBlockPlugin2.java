...
@RefabslabPluginIdentifier(type = AbstractDoubleSlabBlockPlugin.class, major = 1, minor = 18)
public class DoubleSlabBlockPlugin2 extends AbstractDoubleSlabBlockPlugin<Block> {
    @Override
